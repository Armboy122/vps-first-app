...
class Logger {
   ...
   * Log หลัก
   */
  private log(level: LogLevel, category: LogCategory, action: string, details?: Record<string, any>) {
  ...
  private getLogColor(level: LogLevel): string {
    switch (level) {
      ...
      case LogLevel.AUDIT: return '#10B981';
...
export const logFormInteraction = (action: string, details?: Record<string, any>) => 
...
export const logError = (action: string, error: Error | string, details?: Record<string, any>) => 
