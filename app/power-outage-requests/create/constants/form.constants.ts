...
export const FORM_MESSAGES = {
  ...
  VALIDATION: {
    TIME_OUTSIDE_WORKING_HOURS: "เวลาเริ่มต้นต้องอยู่ในช่วง 06:00 - 19:30 น. และเวลาสิ้นสุดต้องอยู่ในช่วง 06:30 - 20:00 น.",
    END_TIME_TOO_EARLY: "เวลาสิ้นสุดต้องมากกว่าเวลาเริ่มต้นอย่างน้อย 30 นาที",
    DATE_TOO_EARLY: "วันที่ดับไฟต้องล่วงหน้าอย่างน้อย 10 วันทำการ",
  },
} as const;
