          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-800">
                <span className="font-medium">ไม่สามารถบันทึกได้:</span>{" "}
                วันที่ที่เลือกต้องมากกว่า 10 วันจากวันปัจจุบัน กรุณาเลือกวันที่{" "}
                {dayjs(minSelectableDate).format("DD/MM/YYYY")} หรือหลังจากนั้น
              </p>
            </div>
          </div>
        </div>
