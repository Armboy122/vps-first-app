    ...
    return (
      <div className="flex flex-col sm:flex-row items-center gap-4">
        ...
        <div className="text-sm text-gray-700 bg-gray-50 px-3 py-1 rounded-md">
          แสดงรายการที่{" "}
          <span className="font-medium text-pea-700">{currentStart}</span> -{" "}
          <span className="font-medium text-pea-700">{currentEnd}</span>{" "}
          จากทั้งหมด{" "}
          <span className="font-medium text-pea-700">{totalItems}</span> รายการ
        </div>
      </div>
    );
  },
