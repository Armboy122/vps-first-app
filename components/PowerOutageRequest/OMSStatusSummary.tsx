    ...
    <div className="mb-6 bg-white rounded-lg shadow-md p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-red-50 rounded-lg p-4 border-l-4 border-red-500">
          ...
          <div className="text-2xl font-bold text-red-900 mb-1">{summaryData.urgentItems}</div>
          <div className="text-sm text-red-700">
        ...
        <div className="bg-yellow-50 rounded-lg p-4 border-l-4 border-yellow-500">
          ...
          <div className="text-2xl font-bold text-yellow-900 mb-1">{summaryData.mediumUrgentItems}</div>
        ...
        <div className="bg-green-50 rounded-lg p-4 border-l-4 border-green-500">
          ...
          <div className="text-2xl font-bold text-green-900 mb-1">{summaryData.normalItems}</div>
        ...
        <div className="bg-green-50 rounded-lg p-4 border-l-4 border-green-500">
          ...
          <div className="text-2xl font-bold text-green-900 mb-1">{summaryData.futureitems}</div>
          <div className="text-sm text-green-700">
